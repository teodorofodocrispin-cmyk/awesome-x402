...
- [Intelica](https://intelica.onrender.com) - Competitive intelligence API for AI agents. Send any URL or text description, get back structured JSON with positioning summary, user pain points, detected competitors, and unique market angles. $0.05 USDC per call on Base mainnet. No accounts, no API keys. Auto-discovery: [/.well-known/x402.json](https://intelica.onrender.com/.well-known/x402.json) | [Docs](https://intelica.onrender.com/docs) | ([GitHub](https://github.com/teodorofodocrispin-cmyk/Intelica))
